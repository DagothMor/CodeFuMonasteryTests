...
namespace MSTest
{
	...
	public class LinkedListUnitTest
	{
		...
		public void TestMethod1()
		{
			...
			var testList2 = new LinkedList();
			testList2.head = a1;
			testList2.tail = a7;

			var testList3 = new LinkedList();
		...
		public void TestMethod2()
		{
			...
			var sumOfList1And2 = LinkedListController.SumTwoLinkedLists(testList, testList2);

			var twoLinkedListsAreEqual = LinkedListController.TwoLinkedListsAreEqual(expected, sumOfList1And2);
			var twoLinkedListsAreNotEqual = LinkedListController.TwoLinkedListsAreEqual(testList, testList2);
